...
//			int rootLayoutId) {
	public FloatWindowSmallView(Context context) {
		...
		LayoutInflater.from(context).inflate(R.layout.float_window_test, this);
		View view = findViewById(R.id.small_window_test);
		...
		//percentView.setTextColor(this.getResources().getColor(R.color.red));
		//percentView.setText("卡尔云");
...
//		smallWindowParams.gravity = Gravity.LEFT | Gravity.TOP;
		smallWindowParams.gravity = Gravity.CENTER | Gravity.TOP;
...
//		smallWindowParams.y = ScreenUtils.getScreenHeight(context)/2;
	 ...
	 * @param mS
	 */
	public void updataText(String mS){
		if(mS!=null){
//			Log.e("执行了updateView","执行了");
			TextView percentView = (TextView) findViewById(R.id.restext);
			percentView.setText(mS);
		}
		else {
			TextView percentView = (TextView) findViewById(R.id.restext);;
	...
	public void updatabaiduText(String mS){
		if(mS!=null){
//			Log.e("执行了updateView","执行了");
			TextView percentView = (TextView) findViewById(R.id.baidutext);
			percentView.setText(mS);
		}
		else {
			TextView percentView = (TextView) findViewById(R.id.baidutext);
	...
	public void updataMyText(String mS){
		if(mS!=null){
//			Log.e("执行了updateView","执行了");
			TextView percentView = (TextView) findViewById(R.id.myrestext);
			percentView.setText(mS);
		}
		else {
			TextView percentView = (TextView) findViewById(R.id.myrestext);
	...
	public void updataMyActText(String mS){
		if(mS!=null){
//			Log.e("执行了updateView","执行了");
			TextView percentView = (TextView) findViewById(R.id.myacttext);
			percentView.setText(mS);
		}
		else {
			TextView percentView = (TextView) findViewById(R.id.myacttext);
	...
	{
		/*Button mTextView = (Button)findViewById(R.id.set_callback);
		Button mHelp = (Button)findViewById(R.id.voice_help);
